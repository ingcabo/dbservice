...
class Model_acc extends My_model{
...
return $usracc;
        ...
        function verifica_metodo_update_exist($control,$funcion,$metodo,$id,$user_id){
               ...
               $query    = $this->db->query("SELECT count(*) as count FROM access WHERE controller =  '/".$control."'  and FUNCTION ='".$funcion."' and metodo = '".$metodo. "' and id <>  '".$id. "'  and status= 'active'  and user_id = ".$user_id);           
