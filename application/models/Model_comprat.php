...
protected $_table = 'vis_lote';
protected $primary_key = 'num_factura';
...
public function ult_track($loteid){

	 $query =  $this->db->query('SELECT * FROM traking k WHERE k.id  = (SELECT MAX(t.id) FROM traking t WHERE t.id_lote ='. $loteid.')');
