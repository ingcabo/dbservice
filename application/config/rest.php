...
|
*/
$config['rest_keys_table'] = 'keys_app';
...
DROP PROCEDURE IF EXISTS `verifica_times_key`$$
...
BEGIN
    ...
    SET last_run_time := (SELECT MAX(ult_acces) AS ult_acces FROM LOGS WHERE  api_key = key_u AND response_code = 200);
